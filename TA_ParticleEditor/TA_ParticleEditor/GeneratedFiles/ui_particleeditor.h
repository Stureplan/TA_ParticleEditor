...
public:
    ...
    void setupUi(QMainWindow *ParticleEditorClass)
    {
        ...
        color1Display->setGeometry(QRect(750, 10, 91, 31));
        ...
        color1Btn->setGeometry(QRect(760, 16, 70, 21));
