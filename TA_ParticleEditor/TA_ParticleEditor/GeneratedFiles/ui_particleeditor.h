...
public:
    ...
    void setupUi(QMainWindow *ParticleEditorClass)
    {
        ...
        label_EmissionDelay->setGeometry(QRect(854, 264, 80, 20));
        ...
        label_Texture->setGeometry(QRect(680, 390, 91, 16));
        ...
        label_StartSize->setGeometry(QRect(661, 317, 91, 16));
        ...
        emitterTypeBox->setGeometry(QRect(990, 286, 121, 24));
        ...
        label_EmitterType->setGeometry(QRect(1000, 266, 100, 16));
        ...
        startSizeX->setGeometry(QRect(670, 336, 35, 20));
        ...
        startSizeY->setGeometry(QRect(707, 336, 35, 20));
        ...
        maxParticles->setGeometry(QRect(870, 336, 45, 20));
        ...
        rectangleWidget->setGeometry(QRect(990, 326, 120, 110));
        ...
        spriteSheetWidget->setGeometry(QRect(770, 437, 81, 24));
        ...
        endSizeY->setGeometry(QRect(787, 336, 35, 20));
        ...
        label_EndSize->setGeometry(QRect(741, 317, 91, 16));
        ...
        endSizeX->setGeometry(QRect(750, 336, 35, 20));
        ...
        textureView->setGeometry(QRect(870, 450, 64, 64));
        ...
        emissionDelaySlider->setGeometry(QRect(880, 286, 60, 22));
        ...
        label_EmDelaySlide->setGeometry(QRect(857, 290, 30, 13));
